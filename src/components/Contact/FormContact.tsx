  ...
  return (
    <div>
      <div className="bg-white dark:bg-card p-8 rounded-lg shadow-lg">
        <h2 className="text-2xl text-gray-900 font-semibold mb-6">{t('contact.messageUs')}</h2>
        ...
        <form ref={form} onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-4">
            <button
              ...
              className={` w-full p-3 rounded-md font-medium text-white transition-colors flex justify-center items-center ${isSubmitting
